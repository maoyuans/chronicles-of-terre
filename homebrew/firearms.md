...
Additionally, damages of firearm attacks **does not** benefit from ability score bonuses inherently, unless specified otherwise. There are certain subclasses and [feats](feats) that allow characters to benefit from their ability score bonus, such as [Sulphric Militant](../subclasses/fighter-sulphric) fighter, [Arcane Warden](../subclasses/ranger-arcane) ranger, or [Gunslinger](../subclasses/rogue-gunslinger) rogue.
